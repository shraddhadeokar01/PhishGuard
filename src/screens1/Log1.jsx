...
//       // ✅ Step 2: Fetch user details from Realtime DB
...
//         }, 1500);
//       } else {
//         showModal('User details not found ❌', 'error');
//       }
//     } catch (error) {
//       console.error('Login Error:', error);
//       if (error.code === 'auth/user-not-found') {
//         showModal('No account found with this email', 'error');
//       } else if (error.code === 'auth/wrong-password') {
//         showModal('Incorrect password', 'error');
